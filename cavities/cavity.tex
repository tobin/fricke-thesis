...
\end{align}
where $\omega_{fsr}\equiv2\pi\nu_0$.  The location of the poles and
zeroes are illustrated in figure~\ref{fig:cavpzmap}.
...
\subsection{Critically-Coupled Cavities}
