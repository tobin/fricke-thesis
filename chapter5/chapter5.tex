...
\caption{\label{fig:laser-AM-contributions}Direct contributions of
...
\caption{Laser intensity noise coupling to DARM.
...
\caption{Laser frequency noise coupling to DARM}
\end{figure}
...
\caption{\label{fig:osc-AM}Oscillator amplitude noise coupling to DARM}
\end{figure}

\begin{figure} % Oscillator PM
\includegraphics[]{figures/oscPM-L1.pdf}
\includegraphics[]{figures/oscPM-H1.pdf}
\caption{\label{fig:osc-PM}Oscillator phase noise coupling to DARM.}
\end{figure}
