...
\begin{figure}
\subfloat[without radiation pressure ($m\to\infty$)]{
\includegraphics[width=\columnwidth]{figures/intensity_noise_contributions_without_rp.pdf}
}\\
\subfloat[with radiation pressure ($m=10.5$ kg)]{
\includegraphics[width=\columnwidth]{figures/intensity_noise_contributions.pdf}
}
