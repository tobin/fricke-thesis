...
to the field of interest--the optical mode of the arm cavities.

The unwanted light which the OMC removes includes the Gaussian mode of
the RF sidebands and spurious higher order modes of both the carrier
and the RF sidebands.  The OMC consists of a Fabry-Perot cavity with
length, g-factor, and finesse chosen to optimally filter the RF
sidebands and spurious higher order modes from the desired DARM
signal.
