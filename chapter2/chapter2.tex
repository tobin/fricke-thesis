...
laser wavelength and the distance between the mirrors:\footnote{There is an additional contribution to the phase, the Guoy phase shift, due to geometric effects; this is described in chapter 4.}
\begin{align}
\phi  & = 2\pi \nu / \nu_0 \\
\nu_0 & = c/(2L)
\end{align}
...
\end{equation}
where $s=i\omega$.  Substitute $\phi=$.
